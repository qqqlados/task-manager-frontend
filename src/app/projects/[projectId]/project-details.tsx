...
import { CalendarDays, User, FileText, CheckCircle2, Circle, PauseCircle, XCircle, Flag } from 'lucide-react';
...
export default function ProjectDetails({ project, tasks }: Props) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <a href={`/projects/${project.id}/edit`} className="btn">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 card bg-base-100 shadow border border-base-200">
          <div className="card-body">
            ...
            <p className="text-base-content/70">{project.description ?? 'No description provided.'}</p>
          </div>
        </div>
      ...
      <div className="card bg-base-100 shadow border border-base-200">
        <div className="card-body">
          <div className="flex items-center justify-between">
            ...
            <a className="btn btn-primary btn-sm" href={`/projects/${project.id}/tasks`}>
          ...
          <div className="overflow-x-auto">
            <table className="table">
              ...
              <tbody>
                {tasks.length > 0 ? (
                  tasks.map((task, idx) => (
                    <tr key={task.id} className="[&>td]:border [&>td]:border-base-200">
                      <td className="text-base-content/60">{idx + 1}</td>
                      <td>
                        <a href={`/projects/${project.id}/tasks/${task.id}`} className="link link-hover inline-flex items-center gap-2">
                      ...
                      <td>
                        <span className="inline-flex items-center gap-2 badge badge-outline">
                          ...
                          {task.status === 'IN_PROGRESS' && <PauseCircle className="w-4 h-4" />}
