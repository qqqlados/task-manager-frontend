...
>(url: string, options: HttpOptions = { tags: [] }): Promise<T> {
	// const token = await getCookies("accessToken");
	const token =
		"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjYsImVtYWlsIjoibHVjYXMubWFydGluQGV4YW1wbGUuY29tIiwiaWF0IjoxNzU3NDE0MTIzLCJleHAiOjE3NTc0MTc3MjN9._ziubUdrt-Vu5iWanLjoQTk37ZKt7ksWXAJ1nRBLPSY";
